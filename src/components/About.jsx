        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-8">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <div className="flex gap-2 justify-center md:justify-start">
              <Button variant="outline" size="icon" className="bg-blue-300 border-none">
                <a href="https://github.com/Pranavlovescode">
                  <Github className="w-4 h-4" />
                </a>
              </Button>
              <Button variant="outline" size="icon" className="bg-blue-400 border-none">
                <a href="https://www.linkedin.com/in/pranav-titambe/">
                  <Linkedin className="w-4 h-4" />
                </a>
              </Button>
              <Button variant="outline" size="icon" className="bg-blue-500 border-none">
                <a href="mailto:pranavtitambe04@gmail.com">
                  <Mail className="w-4 h-4" />
                </a>
              </Button>
              <Button variant="outline" size="icon" className="bg-blue-600 border-none">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-white leading-relaxed">
                I am a software engineer with a passion for web development. As
                a self-taught developer with over 2 years of coding experience,
                I've worked on various projects building full-stack
                applications.
              </p>
            </div>
